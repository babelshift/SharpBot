...
namespace SharpBot.Processors
{
    public class SteamCommandProcessor : IProcessor
    {
        ...
        private readonly DOTA2Econ dota2EconInterface;
        private readonly PlayerService playerServiceInterface;
        private readonly SteamNews steamNewsInterface;

        private Dictionary<uint, string> games = new Dictionary<uint, string>();
        ...
        public async Task InitializeAsync()
        {
            if (!hasInitialized)
            {
                ...
                games = appListResponse.Data.ToDictionary(x => x.AppId, x => x.Name);
                hasInitialized = true;
            }
        }
